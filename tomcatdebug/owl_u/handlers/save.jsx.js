...
var pigeon_67 = new Pigeon(["owl_u"],["owl_u"]);
...
var owl_uService = (function (pigeon) {
    var objPrefix = 'owl_u'
    var listPrefix = 'owl_u'

    var spec = {"id":"string(12),tab:01,disabled:true;用户Id","name":"string(16),tab:02,searchable:true;用户名字","loginId":"string(16),tab:02,searchable:true,unique:true;登录Id","passwordhash":"password,tab:03,searchable:false,hidden:true;密码","random":"string(64),tab:03,searchable:false,hidden:true;密码","isEnable":"choice,values:y_是/n_否,tab:04,searchable:true,hidden:false;是否有效","mobile":"string(16),inputType:mobile,tab:03,searchable:true,unique:true;手机","mobile_verified":"choice,values:y_是/n_否,tab:03,searchable:true;手机是否已经验证","icon":"image,spec:160x160,size:2M,exts:png#jpg#gif#jpeg,tab:04;头像","email":"string(16),tab:05,searchable:true;邮件","email_verified":"choice,values:y_是/n_否,tab:06,searchable:true;邮箱是否已验证","qq":"string(16),tab:06,searchable:true;qq号","qq_openId":"string(16),tab:06,searchable:true;qq openId","qq_icon":"imgageUrl,tab:06,searchable:true;qq 头像","wechat":"url,tab:06,searchable:true;微信号","wechat_openId":"string(16),tab:10;微信 openId","wechat_icon":"imgageUrl,tab:10;微信头像","isFake":"choice,values:y_是/n_否,tab:11,hidden:true,searchable:true;是否马甲","_t":"u","#meta":{"rem":"用户","parent":["platform"],"visitType":["platform"],"projectName":"用户","export":[{"label":"导出完整","mainTitleFormat":{"background":"#474747","color":"#cccccc"},"subTitleFormat":{"background":"#777777","color":"#ffffff"},"subRecordFormat":{"background":"#ffffff","color":"#000000"},"mainRecordFormat":{"background":"#555555","color":"#FFFFFF"},"key":"completeDoc","fields":["*"]}]}}

    var formSpecs = {"meta":{"rem":"用户","parent":["platform"],"visitType":["platform"],"projectName":"用户","export":[{"label":"导出完整","mainTitleFormat":{"background":"#474747","color":"#cccccc"},"subTitleFormat":{"background":"#777777","color":"#ffffff"},"subRecordFormat":{"background":"#ffffff","color":"#000000"},"mainRecordFormat":{"background":"#555555","color":"#FFFFFF"},"key":"completeDoc","fields":["*"]}]},"_ft":"subForm","fields":[{"fieldType":"string","fieldSize":12,"tab":"01","disabled":"true","fieldLabel":"用户Id","_ft":"field","key":"id","origKey":"id"},{"fieldType":"string","fieldSize":16,"tab":"02","searchable":"true","fieldLabel":"用户名字","_ft":"field","key":"name","origKey":"name"},{"fieldType":"string","fieldSize":16,"tab":"02","searchable":"true","unique":"true","fieldLabel":"登录Id","_ft":"field","key":"loginId","origKey":"loginId"},{"fieldType":"password","tab":"03","searchable":"false","hidden":"true","fieldLabel":"密码","_ft":"field","key":"passwordhash","origKey":"passwordhash"},{"fieldType":"string","fieldSize":64,"tab":"03","searchable":"false","hidden":"true","fieldLabel":"密码","_ft":"field","key":"random","origKey":"random"},{"fieldType":"choice","values":"y_是/n_否","tab":"04","searchable":"true","hidden":"false","options":[["y","是"],["n","否"]],"fieldLabel":"是否有效","_ft":"field","key":"isEnable","origKey":"isEnable"},{"fieldType":"string","fieldSize":16,"inputType":"mobile","tab":"03","searchable":"true","unique":"true","fieldLabel":"手机","_ft":"field","key":"mobile","origKey":"mobile"},{"fieldType":"choice","values":"y_是/n_否","tab":"03","searchable":"true","options":[["y","是"],["n","否"]],"fieldLabel":"手机是否已经验证","_ft":"field","key":"mobile_verified","origKey":"mobile_verified"},{"fieldType":"image","spec":"160x160","size":"2M","exts":"png#jpg#gif#jpeg","tab":"04","fieldLabel":"头像","_ft":"field","key":"icon","origKey":"icon"},{"fieldType":"string","fieldSize":16,"tab":"05","searchable":"true","fieldLabel":"邮件","_ft":"field","key":"email","origKey":"email"},{"fieldType":"choice","values":"y_是/n_否","tab":"06","searchable":"true","options":[["y","是"],["n","否"]],"fieldLabel":"邮箱是否已验证","_ft":"field","key":"email_verified","origKey":"email_verified"},{"fieldType":"string","fieldSize":16,"tab":"06","searchable":"true","fieldLabel":"qq号","_ft":"field","key":"qq","origKey":"qq"},{"fieldType":"string","fieldSize":16,"tab":"06","searchable":"true","fieldLabel":"qq openId","_ft":"field","key":"qq_openId","origKey":"qq_openId"},{"fieldType":"imgageUrl","tab":"06","searchable":"true","fieldLabel":"qq 头像","_ft":"field","key":"qq_icon","origKey":"qq_icon"},{"fieldType":"url","tab":"06","searchable":"true","fieldLabel":"微信号","_ft":"field","key":"wechat","origKey":"wechat"},{"fieldType":"string","fieldSize":16,"tab":"10","fieldLabel":"微信 openId","_ft":"field","key":"wechat_openId","origKey":"wechat_openId"},{"fieldType":"imgageUrl","tab":"10","fieldLabel":"微信头像","_ft":"field","key":"wechat_icon","origKey":"wechat_icon"},{"fieldType":"choice","values":"y_是/n_否","tab":"11","hidden":"true","searchable":"true","options":[["y","是"],["n","否"]],"fieldLabel":"是否马甲","_ft":"field","key":"isFake","origKey":"isFake"}],"tab":"99","fieldLabel":"请完善资料"}
    ...
    var f = {
        ...
        index: function (doc) {
            ...
            var searchUrl = elasticSearchUrl + '/owl_u/allinone/' + data.id
        ...
        addExportTask: function (query, env) {
            ...
            var taskId = JobsService.submitExportTask('owl_u', 'tasks/export.jsx', {
                query: query,
                env: env,
        ...
        addDocExportTask: function (docId, env) {
            ...
            //这个key如果不多加一个export，会把原有的单据数据覆盖
            var taskInfoId = objPrefix + '_export_' + pigeon.getId()
            var taskId = JobsService.submitExportTask('owl_u', 'tasks/exportDoc.jsx', {
                id: docId,
                env: env,
                taskInfoId: taskInfoId,
            }, now)
        ...
        search:function(m, searchArgs, keyword,from, pageSize, sort){
            ...
            var searchUrl = elasticSearchUrl+"/owl_u/_search";
...
try {
  ...
  if (!id) {
    //adding
    modelObject.m = m;
    var newdata = owl_uService.add( modelObject,env );
  }
  else {
    var newdata = owl_uService.update( modelObject,env);
  }
